//old design, not used anymore, original page.tsx
...
{/* <div className="">
        <div className="max-w-7xl mx-auto px-5 flex flex-col items-center">
          ...
          <div className="text-black text-3xl md:text-4xl text-center pt-4 pb-5 mb-5">
            Passion Fruit Vanilla, Almond Peach Crumble, Rose Raspberry, Coconut
            Guava
          </div>
...
const Home = () => {
  return (
    <div>
      <div className="bg-[#FCF2E4] h-auto md:h-custom-height flex flex-col md:flex-row items-center justify-center relative p-4">
        <h1 className="text-black text-5xl text-center mb-4 md:mb-8 md:absolute md:top-1/4 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 z-10">
      ...
      <div className="">
        <div className="max-w-7xl mx-auto px-5 flex flex-col items-center">
          <div className="text-black text-4xl md:text-5xl text-center mb-4">
            Local NJ Area Pickups and Deliveries
          </div>
          <div className="text-black text-2xl md:text-3xl text-center py-5">
            {/* Accepting cookie orders now. Select your preferred date! */}
            Accepting cookie orders via email
          </div>
          <div className="flex justify-center mb-20">
            <Link href="/order" passHref>
              <button className="button-83 text-xl md:text-2xl pt-7 py-3 px-6 rounded-full shadow-lg hover:bg-yellow-500 transition-all">
      ...
      <div className="h-screen flex flex-col items-center justify-center p-5 text-center">
        ...
        <div className="max-w-7xl mx-auto px-5">
          <div className="text-black text-3xl md:text-4xl py-5 mb-5 text-center">
            Born from a profound passion for desserts, losnazia is
      ...
      <div>
        <div className="max-w-7xl mx-auto px-5 flex flex-col items-center">
          ...
          <div className="text-black text-3xl md:text-4xl py-5 mb-5 text-center">
            ...
            enhances our offerings and delights our customers." - Fudgarten
          </div>
        </div>
      </div>
    </div>
